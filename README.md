...
This is the official website of [Areli Wray](https://areliwray.com).
...
```bash
git clone https://github.com/cwray-tech/areliwray.com.git
```

### Development

1. First [clone the repo](#clone) if you have not done so already
1. `cd areliwray.com && cp .env.example .env` to copy the example environment variables
